...
func GetParties(keys []string, localPartyKey string, caller string) ([]*btss.PartyID, *btss.PartyID, error) {
	fmt.Printf("Caller %v Picking parties from keys %+v, local party key %v\n", caller, keys, localPartyKey)
